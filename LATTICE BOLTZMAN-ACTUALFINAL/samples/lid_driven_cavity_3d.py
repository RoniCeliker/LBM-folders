...
def main():
    ...
    lattice.setup_streaming(mesh=f"{app_name}.bmsh", connectivity=f"{app_name}.bcon", bc=bc, processes=2)
...
def create_mesh(L: int):
    ...
    boundary_names = {"west": "RESTING_WALL", "east": "RESTING_WALL",
                      "south": "RESTING_WALL", "north": "MOVING_WALL",
                      "back": "RESTING_WALL", "front": "RESTING_WALL"}
    mesh_gen.create_block(nx=L, ny=L, nz=L,
